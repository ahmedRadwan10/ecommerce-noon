...
const ImageSlider = () => {
    ...
    const imgsContainer = useRef();

    const scrollImgsToLeft = () => {
        imgsContainer.current.scrollLeft -= imgsContainer.current.offsetWidth;
    }
    ...
    return (
        <>
            ...
            <div ref={imgsContainer} className={styles.imgs_slider_container}>
